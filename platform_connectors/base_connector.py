...
from platform_connectors.qt_compat import QObject, pyqtSignal


class BasePlatformConnector(QObject):
    """Base class for all platform connectors"""

    # Signals: when PyQt6 is unavailable these become per-instance dummy
    # signals implemented by `qt_compat` so imports don't fail during tests.
