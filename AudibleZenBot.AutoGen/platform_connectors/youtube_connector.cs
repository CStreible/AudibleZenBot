...
namespace platform_connectors.youtube_connector {
    ...
    public class YouTubeConnector {
        ...
        public void SendMessage(string? message) {
            try {
                core.chat_manager.Chat_managerModule.SendMessageAsBot(core.platforms.PlatformIds.YouTube, message, true);
            } catch (Exception ex) {
                Console.WriteLine($"YoutubeConnector.SendMessage error: {ex.Message}");
            }
        }
