...
namespace platform_connectors.twitter_connector {
    ...
    public class TwitterConnector {
        ...
        public void SendMessage(string? message) {
            try {
                core.chat_manager.Chat_managerModule.SendMessageAsBot(core.platforms.PlatformIds.Twitter, message, true);
            } catch (Exception ex) {
                Console.WriteLine($"TwitterConnector.SendMessage error: {ex.Message}");
            }
        }
